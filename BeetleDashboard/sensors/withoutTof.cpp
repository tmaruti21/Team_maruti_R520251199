 ...
 *   left/right_ticks = average delta ticks per interval
 *
...
void setup() {
  ...
  // CSV Header
  Serial.println("t_ms,ax,ay,az,gx,gy,gz,temp,left_ticks,right_ticks");
