#!/usr/bin/env python3
"""Bridge selected cmd_vel to ESP32 motor serial protocol."""
...
class Esp32AutoBridgeNode(Node):
    """Translate Twist commands into ESP32 differential motor packets."""

    def __init__(self) -> None:
        super().__init__('esp32_auto_bridge')
        ...
        self.get_logger().info('ESP32 auto bridge started')
